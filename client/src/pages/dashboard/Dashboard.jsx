                            ...
                            <div key={idx} className="flex items-center gap-4 p-3 rounded-xl hover:bg-slate-50 transition-all border border-transparent hover:border-slate-100 group">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-xs font-bold text-slate-900 truncate">
                                        {activity.type === 'Invoice' ? 'Tax Invoice' : activity.type === 'Proforma' ? 'Proforma' : 'Quotation'} generated by <span className="text-primary-600 uppercase">{activity.User?.ownerName || 'Staff'}</span>
                                    </p>
